...
if($_GET[add]=="ok")
{
    ...
    if(($_POST[nombre]!=""))
    {
            ...
            if(!mysqli_error())
            {
                ...
                echo "<script>window.location='home.php?pagina=categorias';</script>";
            }
                else
                {
               ...
               <div id="accordion">
                     <!-- Page Heading -->
                        <div class="card shadow mb-4" id="headingOne">
                            ...
                            <h6 class="m-0 font-weight-bold text-primary" data-toggle="collapse" data-target="#collapseNuevo" aria-expanded="false" aria-controls="collapseNuevo">Nueva Categoria</h6>
                            </div>
               ...
               <?php
                        ...
                        if($_GET[ver]!=0)
                        {
                            $sql=mysqli_query($con,"select *from categorias where id=$_GET[ver]");
                                ...
                                $url="home.php?pagina=categorias&mod=ok";
                                $showform="show";
                        }
                            else
                            {
                                $url="home.php?pagina=categorias&add=ok";
                                $showtable="show";
                            }
                    ?>
                    ...
                    <div class="card shadow mb-4 mx-auto" >
                        ...
                        <h6 class="m-0 font-weight-bold text-primary" data-toggle="collapse" data-target="#collapseListado" aria-expanded="true" aria-controls="collapseListado">Categorias</h6>
                        </div>
